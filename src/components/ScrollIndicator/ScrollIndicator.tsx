...
export function ScrollIndicator() {
  ...
  return (
    <motion.a
      ...
      style={{ opacity, y }}
      className="absolute left-1/2 bottom-5 sm:bottom-6 z-30 -translate-x-1/2 flex flex-col items-center gap-2 text-cream-200/80 hover:text-ember-500 transition-colors"
    >
