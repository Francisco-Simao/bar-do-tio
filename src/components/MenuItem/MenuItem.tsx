...
export function MenuItem({ item, index }: Props) {
  return (
    <motion.article
      ...
      className="group relative flex flex-col bg-char-900/60 border border-cream-200/8 hover:border-ember-500/40 transition-all duration-500 rounded-sm overflow-hidden"
    >
      ...
      <div className="flex flex-col gap-2 p-4 md:p-5">
        <h3 className="font-editorial text-xl md:text-2xl text-cream-100 leading-tight">
          {item.name}
        </h3>
        ...
        <div className="flex items-end justify-between mt-3">
          ...
          <span className="text-[9px] tracking-wider-3 uppercase text-cream-200/40">
            Bar do Tio
          </span>
        </div>
      </div>
